...
from openadr3_client.oadr310.conversion.input.events.dict import DictEventIntervalConverter
from openadr3_client.oadr310.conversion.output.events.dict import DictEventIntervalConverter as DictEventIntervalConverterOutput
