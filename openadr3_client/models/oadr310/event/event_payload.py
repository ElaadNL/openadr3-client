...
from openadr3_client.models.oadr310.common.payload import AllowedPayloadInputs, BasePayloadDescriptor, _BasePayload
...
class EventPayloadType(str, Enum):
    ...
    CONTROL_LEVEL_OFFSET = "CONTROL_LEVEL_OFFSET"
    CONTROL_LEVEL_OFFSET_PERCENT = "CONTROL_LEVEL_OFFSET_PERCENT"
