...
class VensReadOnlyInterface:
    ...
    def get_ven_by_id(self, ven_id: str) -> ExistingVen:
        ...
        """
        response = bearer_authenticated_session.get(f"{base_prefix}/{ven_id}")
        response.raise_for_status()
    ...
    def get_ven_resource_by_id(self, ven_id: str, resource_id: str) -> ExistingResource:
        ...
        """
        response = bearer_authenticated_session.get(f"{base_prefix}/{ven_id}/resources/{resource_id}")
        response.raise_for_status()

        return ExistingResource.model_validate_json(response.json())
    

class VensWriteOnlyInterface:
    ...
    def create_report(self, new_ven: NewVen) -> ExistingVen:
        ...
        with new_ven.with_creation_guard():
            response = bearer_authenticated_session.post(base_prefix, data=new_ven.model_dump_json())
            response.raise_for_status()
            return ExistingVen.model_validate_json(response.json())
    ...
    def update_report_by_id(self, ven_id: str, updated_ven: ExistingVen) -> ExistingVen:
        ...
        response = bearer_authenticated_session.put(f"{base_prefix}/{ven_id}",
    ...
    def delete_ven_by_id(self, ven_id: str) -> None:
        ...
        """
        response = bearer_authenticated_session.delete(f"{base_prefix}/{ven_id}")
        response.raise_for_status()
    ...
    def delete_ven_resource_by_id(self, ven_id: str, resource_id: str) -> None:
        ...
        """
        response = bearer_authenticated_session.delete(f"{base_prefix}/{ven_id}/resources/{resource_id}")
        response.raise_for_status()
